...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "My Dearest Rose, if I should stay, I'd only be in your way… but I carry you in my heart always. Every breath I take whispers your name softly into the universe. Each step I take, you're there — my light, my peace, my reason. I will always love you — not just in words, but in the quiet spaces in between. Bittersweet memories… that's all I'm taking with me, and it's enough to last a lifetime. Goodbye doesn't mean forgetting — it means loving from afar, faithfully. I hope life treats you kind and brings you joy that outshines the sun. I hope your dreams unfold gently like petals in spring. But most of all — above all wishes — I wish you love. You are my once-in-a-lifetime, my forever feeling. Even if the world forgets our names, my soul will still remember yours.",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
        ...
        {yesPressed && noCount>3 ? (
          <>
            <img
              ...
              alt="Yes Response"
            />
            <div className="text-4xl md:text-6xl font-bold my-2" style={{ fontFamily: "Charm, serif", fontWeight: "700", fontStyle: "normal" }}>I Love You  ROSE!!!</div>
          ...
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center">
              Hey Rose, Do ever wakeup in the middle of the night because you miss me?
            </h1>
...
const Footer = () => {
  return (
    <a
      ...
      href="https://github.com/ARIHO256aini07"
      target="_blank"
